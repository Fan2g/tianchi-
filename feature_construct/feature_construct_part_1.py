...
df_part_1_c_b_count = pd.merge(df_part_1_c_b_count_in_6, df_part_1_c_b_count_in_3, on=['item_category'],
                               how='left').fillna(0)
df_part_1_c_b_count = pd.merge(df_part_1_c_b_count, df_part_1_c_b_count_in_1, on=['item_category'], how='left').fillna(
    0)
...
df_part_1_ui_b_last_time['ui_b1_last_time'] = df_part_1_ui_b_last_time[df_part_1_ui_b_last_time['behavior_type'] == 1][
    'time']
df_part_1_ui_b_last_time['ui_b2_last_time'] = df_part_1_ui_b_last_time[df_part_1_ui_b_last_time['behavior_type'] == 2][
    'time']
df_part_1_ui_b_last_time['ui_b3_last_time'] = df_part_1_ui_b_last_time[df_part_1_ui_b_last_time['behavior_type'] == 3][
    'time']
df_part_1_ui_b_last_time['ui_b4_last_time'] = df_part_1_ui_b_last_time[df_part_1_ui_b_last_time['behavior_type'] == 4][
    'time']
...
df_part_1_uc_b_count = pd.merge(df_part_1_uc_b_count_in_6, df_part_1_uc_b_count_in_3, on=['user_id', 'item_category'],
                                how='left').fillna(0)
...
df_part_1_uc_b_last_time['uc_b1_last_time'] = df_part_1_uc_b_last_time[df_part_1_uc_b_last_time['behavior_type'] == 1][
    'time']
df_part_1_uc_b_last_time['uc_b2_last_time'] = df_part_1_uc_b_last_time[df_part_1_uc_b_last_time['behavior_type'] == 2][
    'time']
df_part_1_uc_b_last_time['uc_b3_last_time'] = df_part_1_uc_b_last_time[df_part_1_uc_b_last_time['behavior_type'] == 3][
    'time']
df_part_1_uc_b_last_time['uc_b4_last_time'] = df_part_1_uc_b_last_time[df_part_1_uc_b_last_time['behavior_type'] == 4][
    'time']
...
print('feature construct 1 done!')