...
#####output file
path_df_result = "/media/dell/Data/FHQ/tianchi/recommend/Ir/res_LR_k_means_subsample.csv"
path_df_result_tmp = "/media/dell/Data/FHQ/tianchi/recommend/Ir/df_result_tmp.csv"
...
def train_set_construct(np_ratio=1, sub_ratio=1):
    ...
    frac_ratio = float(np_ratio)*float(sub_ratio) / 1200
    print(np_ratio,sub_ratio,frac_ratio)
    ...
    train_X_1 = train_part_1_df.as_matrix(
    ...
    # using all the features without missing value for valid lr model
    train_X_2 = train_part_2_df.as_matrix(
        ['u_b1_count_in_6', 'u_b2_count_in_6', 'u_b3_count_in_6', 'u_b4_count_in_6', 'u_b_count_in_6',
         'u_b1_count_in_3', 'u_b2_count_in_3', 'u_b3_count_in_3', 'u_b4_count_in_3', 'u_b_count_in_3',
         'u_b1_count_in_1', 'u_b2_count_in_1', 'u_b3_count_in_1', 'u_b4_count_in_1', 'u_b_count_in_1',
         'u_b4_rate',
...
def valid_set_construct(sub_ratio=0.1):
    ...
    # using all the features without missing value for valid lr model
    valid_X_1 = valid_part_1_df.as_matrix(
        ['u_b1_count_in_6', 'u_b2_count_in_6', 'u_b3_count_in_6', 'u_b4_count_in_6', 'u_b_count_in_6',
         'u_b1_count_in_3', 'u_b2_count_in_3', 'u_b3_count_in_3', 'u_b4_count_in_3', 'u_b_count_in_3',
         'u_b1_count_in_1', 'u_b2_count_in_1', 'u_b3_count_in_1', 'u_b4_count_in_1', 'u_b_count_in_1',
         'u_b4_rate',
    ...
    # using all the features without missing value for valid lr model
    valid_X_2 = valid_part_2_df.as_matrix(
        ['u_b1_count_in_6', 'u_b2_count_in_6', 'u_b3_count_in_6', 'u_b4_count_in_6', 'u_b_count_in_6',
         'u_b1_count_in_3', 'u_b2_count_in_3', 'u_b3_count_in_3', 'u_b4_count_in_3', 'u_b_count_in_3',
         'u_b1_count_in_1', 'u_b2_count_in_1', 'u_b3_count_in_1', 'u_b4_count_in_1', 'u_b_count_in_1',
         'u_b4_rate',
...
f1_scores = []
cut_offs = []
valid_X, valid_y = valid_set_construct(sub_ratio=0.2)
train_X, train_y = train_set_construct(np_ratio=35, sub_ratio=0.8)
print(valid_X.shape,train_X.shape)
...
for pred_uic in pd.read_csv(open(path_df_part_3_uic, 'r'), chunksize=100000):
    try:
        ...
        pred_y = (LR_clf.predict_proba(standardized_pred_X)[:, 1] > 0.8).astype(int)
        print("c", LR_clf.predict_proba(standardized_pred_X))
